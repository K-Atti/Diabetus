...
public class FoodEntry implements Parcelable, Eatable {
    ...
    public FoodEntry(String name, String brand, double calorie, double trans_fat, double saturated_fat, double unsaturated_fat, double sodium, double carb, double sugar, double fiber, double protein, double weight, boolean local) {
        this.name = name;
        this.brand = brand;
    ...
    public FoodEntry(UsdaData usda) {
        name = usda.getDescription().toLowerCase(Locale.ROOT);
        brand = "";
