...
public class Meal implements Parcelable, Eatable {
    ...
    public double getCalorie() {
        return foodList.stream().mapToDouble(Food::getCalorie).sum();
    }

    public double getProtein() {
        return foodList.stream().mapToDouble(Food::getProtein).sum();
    }

    public double getCarb() {
        return foodList.stream().mapToDouble(Food::getCarb).sum();
    }

    public double getFat() {
        return foodList.stream().mapToDouble(Food::getFat).sum();
    }

    public double getFiber() {
        return foodList.stream().mapToDouble(Food::getFiber).sum();
    }
    ...
    public String getMacros() {
        return "Cal: " + String.format(Locale.getDefault(),"%.2f", this.getCalorie()) +
                " Carb: " + String.format(Locale.getDefault(),"%.2f", this.getCarb()) +
                " Prot: " + String.format(Locale.getDefault(),"%.2f", this.getProtein()) +
                " Fat: " + String.format(Locale.getDefault(),"%.2f", this.getFat());
    }
